<?php
    ...
    $LGD_CUSTOM_CEONAME 		= $HTTP_POST_VARS["LGD_CUSTOM_CEONAME"];    	//상점 대표자명
    ...
    $LGD_TID        			= $HTTP_POST_VARS["LGD_TID"];					//텔레콤 거래번호
	 ...
	 $configPath 				= $_SERVER[DOCUMENT_ROOT]."/module/lgxpay/lgdacom";			//LG텔레콤에서 제공한 환경파일("/conf/lgdacom.conf") 위치 지정. 	  
