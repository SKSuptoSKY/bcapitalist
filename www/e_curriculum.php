		...
		<div id="c_section1">
			<div class="inner">
				...
				<div class="c_sec1_con">
					<img src="/e_images/main/e_aboutus_no_img.png" alt="">
				</div><!-- //c_sec2_con -->
			</div><!-- //inner -->
		</div><!-- //c_section1 -->
		...
		<div id="c_section2">
			<div class="inner">
				...
				<div class="c_sec2_con">
					<img src="/e_images/main/e_c_sec2_con.png" alt="">
				</div><!-- //c_sec2_con -->
		...
		<div id="c_section3">		
			<div class="inner">
				...
				<div class="c_sec3_con">
					<img src="/e_images/main/e_c_sec3_con.png" alt="">
				</div><!-- //c_sec3_con -->
			</div><!-- //inner -->
		</div><!-- //section3 -->
		...
		<div id="c_section4">
			<div class="inner">
				...
				<div class="c_sec4_con">
					<img src="/e_images/main/e_c_sec4_con.png" alt="">
				</div><!-- //c_sec2_con -->				
			</div><!-- //inner -->
		</div><!-- //c_section4 -->
