			...
			<colgroup width="">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
                        ...
                        <font color="#FF0000">상품구입시 상품가격의 입력된 %만큼 적립금이 사용가능합니다.</font>
                        </div>
					</td>
				</tr>
				<!--
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<input type="text"  name="shop_inc_head" value="<?=$GnShop[shop_inc_head]?>" style="width:100%; height:19px;" class="text">
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#F0F0F0" style="padding-left:10px">하단인클루드</td>
					<td>
						<input type="text"  name="shop_inc_foot" value="<?=$GnShop[shop_inc_foot]?>" style="width:100%; height:19px;" class="text">
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
		...
		<td valign="top">
			...
			<colgroup width="">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<textarea  name="explan_trans" style="width:100%; height:'170'" class="text"><?=$GnShop[explan_trans]?></textarea>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#F0F0F0" style="padding-left:10px">교환/반품/환불안내</td>
					<td>
						<textarea  name="explan_chan" style="width:100%; height:'170'" class="text"><?=$GnShop[explan_chan]?></textarea>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#F0F0F0" style="padding-left:10px">유의사항</td>
					<td>
						<textarea  name="explan_other" style="width:100%; height:'170'" class="text"><?=$GnShop[explan_other]?></textarea>
					</td>
				</tr>
				<!--
				<tr bgcolor="#FFFFFF">
			...
			<colgroup width="">
				...
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#F0F0F0" style="padding-left:10px">문자발송내용</td>
					<td>
						<table width="100%">
							<tr>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">주문</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text1" cols="20" rows="10" class="text"><?=$GnShop[sms_text1]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">상품준비중</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text2" cols="20" rows="10" class="text"><?=$GnShop[sms_text2]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">배송중</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text3" cols="20" rows="10" class="text"><?=$GnShop[sms_text3]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">완료</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text4" cols="20" rows="10" class="text"><?=$GnShop[sms_text4]?></textarea></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">취소</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text5" cols="20" rows="10" class="text"><?=$GnShop[sms_text5]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">반품</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text6" cols="20" rows="10" class="text"><?=$GnShop[sms_text6]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
									<table width="90%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td bgcolor="#f4f4f4" align="center" height="20">품절</td>
										</tr>
										<tr>
											<td><textarea  name="sms_text7" cols="20" rows="10" class="text"><?=$GnShop[sms_text7]?></textarea></td>
										</tr>
									</table>
								</td>
								<td width="25%">
