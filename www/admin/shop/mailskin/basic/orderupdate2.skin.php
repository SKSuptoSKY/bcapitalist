					...
					<td style="border:2px solid #ebebeb;" height="47px;" >
						<table width="" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td width="15px;"></td>
								<td><strong style="color:#05c300;"><?=$od_id?></strong></td>
							</tr>
						</table>
					</td>
				</tr>
										...
										<Table width="" cellpadding="0" cellspacing="0" border="0">
											<tr>
												...
												<td style="padding:7px 0 7px 0;border-top:1px solid #e5e5e5;color:#4c4c4c; border-bottom:none; border-top:none; line-height:18px;" valign="top" valign="top">
													<table width="100%" cellpadding="0" cellspacing="0" border="0">
														<tr>
															<td style="padding:7px 0 7px 0;border-top:1px solid #e5e5e5;color:#4c4c4c; border-bottom:none; border-top:none; line-height:18px;"><?=$list[$i][it_name]?>
				...
				<tr>
					<td>
                        ...
                        <? if ($od_receipt_card > 0) { ?>
							<tr>
								<th style="border-top:2px solid #383d4a;padding:10px 0 10px 0; background:#f9f9f9; text-align:center;">신용카드 입금액</th>
								<td style="border-top:2px solid #383d4a;padding-left:5px;"><?=display_amount($od_receipt_card)?></td>
							</tr>
                        <? } ?>							
						<? if ($od_receipt_bank > 0) { ?>							
							<tr>
								<th style="border-top:2px solid #383d4a;padding:10px 0 10px 0; background:#f9f9f9; text-align:center;">무통장 입금액</th>
								<td style="border-top:2px solid #383d4a;padding-left:5px;"><?=display_amount($od_receipt_bank)?></td>
							</tr>
						<? } ?>
					...
					<td>
						<Table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td align="right" style="font-size:11px;">상세한 내용은 주문서 조회 화면에서 확인하실 수 있습니다.&nbsp;&nbsp;<a href="http://<?=$_SERVER[SERVER_NAME]?>/shop/myorder_view.php?od_id=<?=$od_id?>&on_uid=<?=$s_on_uid?>" target="_blank"><img src="http://<?=$_SERVER[SERVER_NAME]?>/images/shop/go.jpg" align="absmiddle" border="0"></a></td>
							</tr>
						</table>
					</td>
				</tr>
