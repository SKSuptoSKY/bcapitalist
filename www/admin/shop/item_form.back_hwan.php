...
<colgroup width="">
	...
	<tr bgcolor="#FFFFFF" id="opt_view" style="display:<? if (!$it[it_opt_use]) { ?>none;<? } ?>;">
		...
		상품옵션<br>
		<img src="../images/btn_addrow.gif" align="absmiddle" style="cursor:pointer;" onClick="addRow();">
		</td>
		<td>
...
<tr align="center" bgcolor="#F6F6F6">
	<td>옵션명</td>
	<td bgcolor="#ffffff" style="text-align:left;"><input type="text" name="it_opt1_subject" size="20" class="text" value=""> &nbsp;<a href="javascript:;" onclick="op_add('',1)">속성추가+</a></td>
</tr>
<tr align="center" bgcolor="#FFFFFF">
	<td colspan="2" style="text-align:left; padding-left:50px;">
		<table width="100%" cellpadding="0" cellspacing="0" border="0" id="addTable1">
			...
			<col />
			<tr>
				<td><b>┗</b> 속성 : <input type="text" name="it_op_name[]" id="it_op_name[]" class="text" style="width:150px;" value=""></td>
				<td> 재고 : <input type="text" name="it_op_stock[]" id="it_op_stock[]" class="text" style="width:50px;" value="" onkeyup="stock_add()">개</td>
				<td> 가격 : 
					<select name="it_op_amount_sel[]">
						<option value="+" selected>+</option>
						<option value="-" >-</option>
					</select>
					<input type="text" name="it_op_amount[]" id="it_op_amount[]" value="" class="text" style="width:100px;"> 원
					<input type="hidden" name="it_op_type[]" value="1">
				</td>
			</tr>
		</table>
	</td>
	<td style="padding-left:10px;cursor:pointer;" onclick="deleteRow(this);">삭제</td>
</tr>
</textarea>
						<table id="MainTable" width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#E0E0E0">
							<!-- <col width="67" />
							<col width="800" /> -->
							<tr>
								...
								<td style="padding-left:10px;cursor:pointer;" onclick="deleteRow(this);">
								삭제
								</td>
