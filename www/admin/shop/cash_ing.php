...
<form name=cash_pay method=post action=cash_result.php>
<input type=hidden name=Retailer_id value="<?=$rRetailer_id?>">
<input type=hidden name=Ord_No value="<?=$Ord_No?>">
<input type=hidden name=on_uid	 value="<?=$on_uid?>">  <!-- 주문번호 확장 -->
...
<input type=text style=width:100px name=od_name	 value="<?=$od_name?>">
<input type=hidden style=width:100px name=cash_id value="<?=$cash_id?>"> <!-- DB ID -->
</body>
</html>
