...
?>
			...
			?>
				...
				카드 : <?=number_format($row[od_receipt_card])?>&nbsp;&nbsp;&nbsp;
				<? } ?>
				<? if($row[od_receipt_bank]) { ?>
				현금 : <?=number_format($row[od_receipt_bank])?>&nbsp;&nbsp;&nbsp;
				<? } ?>
				</td></tr>
				</table>
				</td>
...
?>
    <tr>
        ...
        <td colspan=3 bgcolor=#FFFFFF>
            <table width="100%" cellpadding=2 cellspacing=0 border=1 bordercolordark='white' bordercolorlight='gray' align=right>
            <tr>
            ...
            <tr>
                <td colspan=2 align=right><b>현 금 합 계</b> &nbsp;</td>
