<?
	...
	// 출력할 레코드를 얻음
	$sql = " select ref_url , count(con_id) as count from $PG_table $sql_search group by ref_url order by ref_url ";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td height="30" bgcolor="#F5F5F5" style="padding-left:5px;">
			<strong><font color="#004080"><img src="/admin/images/title_icon.gif" width="10" height="9"> <?=$domain?> 접속경로 통계</font></strong>
		</td>
	</tr>
	<tr> 
		<td height="1" bgcolor="#E0E0E0"> </td>
