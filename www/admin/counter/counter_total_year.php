<?
	...
	// 출력할 레코드를 얻음
	$sql = " select SUBSTRING(con_date,1,4) as year, count(con_id) as count from $PG_table $sql_search group by year order by year ";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td height="30" bgcolor="#F5F5F5" style="padding-left:5px;">
			<strong><font color="#004080"><img src="/admin/images/title_icon.gif" width="10" height="9"> 년별 접속자 통계</font></strong>
		</td>
