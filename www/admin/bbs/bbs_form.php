...
$JO_table = "";
	...
	##게시판 스킨 선택
	$dir=opendir($G_board["skin_dir"]);
	while($file=readdir($dir)) {
		if($file != "." && $file != ".."){ 
			if($file == $view[skin]) {
				$skin_list .= "<option value='".$file."' selected>".$file."</option>"; 
			}else {
				$skin_list .= "<option value='".$file."'>".$file."</option>";
			}
		}
	}
	closedir($dir);
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
<form name=F method=post action="./bbs_update.php" onsubmit="return fitemformcheck(this)" enctype="MULTIPART/FORM-DATA" autocomplete="off" style="margin:0px;">
...
<input type=hidden name="qstr"  value="<?=$qstr?>">
	<tr>
		<td width="55%" valign="top">
			...
			<colgroup width=100>
			<colgroup width="">
				<tr bgcolor=white height=50><td colspan=2 style=padding-left:10px><b>게시판 기본셋팅</b> <font color=red> * 설정값 변경시 업체와 상담해주세요</font></td></tr>
				<tr bgcolor="#FFFFFF"> 
					<td bgcolor="#F0F0F0" style="padding-left:10px">테이블명(영문)</td>
					<td>
						<input type=hidden name="dbname"  value="<?=$view["dbname"]?>"><?=$view["dbname"]?>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF"> 
					<td bgcolor="#F0F0F0" style="padding-left:10px">게시판 제목</td>
					<td>
		...
		<td width="45%" valign="top">
			...
			<colgroup width=100>
			<colgroup width="">
				<tr bgcolor=white height=50><td colspan=2 style=padding-left:10px><b>게시판 기능설정</b> <font color=red>  </font></td></tr>
				<?/*?>
				<tr bgcolor="#FFFFFF"> 
				...
				<tr bgcolor=white height=50><td colspan=2 style=padding-left:10px><b>게시판 권한설정</b> </td></tr>
				<tr bgcolor="#FFFFFF"> 
				...
				<tr bgcolor="#FFFFFF"> 
					<td bgcolor="#F0F0F0" style="padding-left:10px">댓글 쓰기 권한</td>
					<td>
...
<table width="100%">
	<tr>
		<td align=center height=50>
			...
			<a href="./bbs_list.php?<?=$qstr?>"><img src="/btn/btn_list.gif" border=0></a>
		</td>
	</tr>
</table>
</form>