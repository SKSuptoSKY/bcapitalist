...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		...
		<textarea name="b_content" id="b_content" rows="8" style="width:100%; height:160px;  min-width:99px;border:1px solid #e2e2e2" class="text"><?=$content?></textarea>
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
<? if($Category_option==TRUE) {?>
...
<? if($Board_Admin["use_html"]==TRUE){?>
	...
	nhn.husky.EZCreator.createInIFrame({
		...
		sSkinURI: "/editor/SmartEditor3Skin_mobile.html",
