    ...
    <td colspan="6">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #ddd;">
            <tr>
                ...
                <?
					$bodytag =$view["content"];
					$bodytag = str_replace("rwidth", "rwidth-", $bodytag);
					$bodytag = str_replace("rheight", "rheight-", $bodytag);
					$bodytag = str_replace("width", "width-", $bodytag);
					$bodytag = str_replace("height", "height-", $bodytag);
					$bodytag = str_replace("WIDTH", "WIDTH-", $bodytag);
					$bodytag = str_replace("HEIGHT", "HEIGHT-", $bodytag);
					$bodytag = str_replace("<IMG", "<IMG style='width:100%'", $bodytag);
					$bodytag = str_replace("<img", "<img style='width:100%'", $bodytag);
					$bodytag = str_replace("<TABLE", "<TABLE style='width:100%'", $bodytag);
					$bodytag = str_replace("<table", "<table style='width:100%'", $bodytag);
					if($bodytag) echo $bodytag;
				?>
                </div>
            	</td>
            </tr>
