...
<div id="wrap">
			...
			<div class="resist_con">
				<form name="resist" method="POST" enctype="multipart/form-data" validate="UTF-8">
					...
					<div class="price_box">
						<div class="price">
							<ul>
								<li>금액 <span><?=number_format($lec[lec_pay])?>원 (VAT 없음)</span></li> <br />
								<!-- <li>VAT 10% <span><?=number_format($vat)?>원</span></li> -->
							</ul>
						</div>
						<div class="price_total">
							<ul>			
								<li>총 결제금액 <?=number_format($lec[lec_pay])?><!--<span><?=number_format($total_pay)?> -->원</span></li>
							</ul>
						</div>
					</div>
					...
					<div class="form01">
						...
						<div class="form_line">
							<strong>직책<span>＊</span></strong>
							<span><input type="text" name="order_position"></span>
						...
						<div class="form_line">
							...
							<strong>추천인<span>＊</span></strong><!-- 추가한것 -->
							<span><input type="text" name="order_referral"></span><!-- 추가한것 -->
						</div>
						<div class="form_line">
				...
				<div class="form-btn"><a href="javascript:writeChk(document.resist);">다음</a></div>
					...
					<div class="sub-tit"><h3>계좌안내</h3></div>
					<div class="form01">
						<div class="form_line">
							<strong style="width:100%;">예금주<span>＊</span> : (주)멀티캠퍼스</strong>
							<strong style="width:100%;">계좌번호<span>＊</span> : 052 - 259245 - 13 - 201 (우리은행)</strong>
							<strong style="width:100%;">위의 계좌로 이체완료시 수강신청이 최종완료됩니다.</strong>
						</div>
	...
	<div id="footer">
		...
		<div class="fooer_sns">
			...
			<span><a href="<?=$link[li_link3]?>" target="<?=$link[li_target3]?>"></a>c</span>
