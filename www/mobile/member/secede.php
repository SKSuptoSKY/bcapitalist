...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td class="formok">
		<input type="submit" border="0" value="확인" style="width:70px; height:27px; background:#f8f8f8;  font-weight:700; border:1px solid #dbdbdb; color:#111111; text-align:center; line-height:1.5; vertical-align:top; cursor:pointer; font-family:Nanumgothic;">&nbsp;
		<a href="/member/member_form.php?mode=INFO"><div style="width:70px; height:25px; background:#f8f8f8; color:#111; font-weight:700; border:1px solid #dbdbdb; text-align:center; line-height:2; display:inline-block;">취소</div></a>
		</td>
	</tr>
</table>
</form>
