...
function copyValue(form){
	...
	opener.document.forderform.<?=$target1?>.value = val[0];
	opener.document.forderform.<?=$target2?>.value = val[1];
	opener.document.forderform.<?=$target3?>.focus();
	window.close();
}
    ...
    <td align="center"><table width="485" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
            <td align="center"> <input type="text" name="dong" style="width:150; height:19px; color:#666666; font-size:9pt; background-color:#ffffff; border:1 #DFDFDF solid"> 
              <input type=image src="/member/images/search_btn.gif" width="38" height="18" align="absmiddle"> 
            </td>
        </tr>
        <tr> 
          <td height="8"> </td>
          ...
          <td><table width="100%" border="0" cellpadding="8" cellspacing="0" bgcolor="#F7F7F7">
              <tr> 
                <td align="center">해당주소를 선택하세요.<br>
					...
					<?
					if($dong) {
						$re=$DB->SELECT("zipcode","*","WHERE dong LIKE '%".$dong."%' ORDER BY seq");
						for($i=0;$i<$re[cnt];$i++) {
        ...
        <tr>
          <td align="center"><input type=image src="/member/images/use_btn.gif" width="59" height="18">
            </td>
        </tr>
		</form>
        <tr> 
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="80%"><img src="/member/images/address_check_foot.gif" width="386" height="20"></td>
                <td width="20%" align="right"><a href="javascript:window.close()"><img src="/member/images/foot_close_btn.gif" width="99" height="20"></a></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
