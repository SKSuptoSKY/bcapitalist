...
<style type="text/css">
.member_info th{height:40px; border-bottom:1px solid #dddddd; text-align:left; padding-left:15px; color:#333333; }
.member_info td{border-bottom:1px solid #dddddd; padding-left:15px;}
input.input_txt{border:1px solid #d3d3d3; height:26px; text-indent:5px;}
select{height:28px; border:1px solid #d3d3d3}
...
input.btn_type_31{width:150px; height:34px; border:1px solid #444444; background:#ffffff; color:#222222; line-height:34px; text-align:center; font-weight:bold;
display:inline-block; vertical-align:middle; cursor:pointer; }

</style>

<table width="100%" border="0" cellpadding="0" cellspacing="0" class="member_info">
	<colgroup>
		<col width="21%" />
		<col width="79%" />
	</colgroup>
	<tr>
		<td align="right" colspan="2" style="padding:5px; border-bottom:none"><span style="font-weight:bold;">별표시(<span style="color:#ff0000">*</span>)는 필수 입력사항입니다.</td>
	</tr>
	<tr bgcolor="#808285"><td height="1" colspan="2" style="border-bottom:none"></td></tr>
	<tr>
		...
		<td bgcolor="#FFFFFF" style="padding-left:15px;">
			<input type="text" name="id" id="id" class="input_txt" value="<?=$mem[mem_id]?>" <? if ($mode=='INFO') { echo "readonly style='background-color:#eeeeee;'"; } ?>
			<? if ($mode=='JOIN') { echo "onblur='CheckID(this);'"; } ?>>
	...
	<tr>
		...
		<td>
			<input type="password" name="mem_pass" class="input_txt mt5" style="width:400px" maxlength="20" onchange="CheckPASS(this);">
	...
	<tr>
		...
		<td><input type="password"  class="input_txt" style="width:400px" name="mem_passChk"  maxlength="20">
		</td>
	</tr>
	<tr>
		...
		<td style="padding-bottom:3px">
			...
			<input type="text" name="email1" value="<?=$email_arr[0]?>" class="input_txt mt3" style="width:28%;" onblur="check_email(this.form);" /> @
			<input type="text" name="email2" value="<?=$email_arr[1]?>" class="input_txt" style="width:28%;" onblur="check_email(this.form);" />

			<select name="domain" onChange="select_domain(this.form, this.value);" class="md5">
	...
	<tr>
		<th>홈페이지</th>
		<td><input type="text" name="mem_home" value="<?=$mem[mem_home]?>" class="input_txt" style="width:200px"></td>
	</tr>
	<tr>
		<th>생년월일</th>
		<td>
	...
	<tr>
		<th>연락처 </th>
		<td>
			<input type="text" name="mem_tel01" value="<?=$mem_tel[0]?>" class="input_txt" style="width:90px" maxlength=3> -
			<input type="text" name="mem_tel02" value="<?=$mem_tel[1]?>" class="input_txt" style="width:100px" maxlength=4> -
			<input type="text" name="mem_tel03" value="<?=$mem_tel[2]?>" class="input_txt" style="width:100px" maxlength=4>
		</td>
	</tr>
	<tr>
		<th>휴대폰<span style="color:#ff0000">*</span></th>
		<td>
			<input type="text" name="mem_phone01" value="<?=$mem_phone[0]?>" class="input_txt" style="width:90px" maxlength=3> -
			<input type="text" name="mem_phone02" value="<?=$mem_phone[1]?>" class="input_txt" style="width:100px" maxlength=4> -
			<input type="text" name="mem_phone03" value="<?=$mem_phone[2]?>" class="input_txt" style="width:100px" maxlength=4>
		</td>
	</tr>
	<tr>
		<th>팩스번호</th>
		<td>
			<input type="text" name="mem_fax01" value="<?=$mem_fax[0]?>" class="input_txt" style="width:90px" maxlength=3> -
			<input type="text" name="mem_fax02" value="<?=$mem_fax[1]?>" class="input_txt" style="width:100px" maxlength=4> -
			<input type="text" name="mem_fax03" value="<?=$mem_fax[2]?>" class="input_txt" style="width:100px" maxlength=4>
		</td>
	</tr>
	<tr>
		<th>주소</th>
...
<table align="center">
	<tr>
		<td height=100>
<? if($mode=="JOIN") { ?>
			<input type="submit" value="확인" class="btn_type_31" style="cursor:pointer;">
<? } else { ?>
			<input type="submit" value="수정하기" class="btn_type_31" style="cursor:pointer;">
<? } ?>
		</td>
	</tr>
</table>
