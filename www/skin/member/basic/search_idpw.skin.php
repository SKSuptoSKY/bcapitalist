...
<style type="text/css">
td {font-family: "굴림"; color: #666666; font-size: 9pt; line-height: 20px;}
...
<tr>
    <td valign="top"><Table width="615px;" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
			<td height="50">
        ...
        <tr>
          <td><font color="#000000"><strong>비밀번호</strong></font></td>
          <td>
            <?=$newPass?>
          </td>
        </tr>
