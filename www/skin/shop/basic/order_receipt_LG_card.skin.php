...
$LGD_CASNOTEURL	   = $GnShop["LG_pg_casurl"];
...
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/module/lgxpay/payres.php">
...
<input type="hidden"	id="LGD_HASHDATA" name ="LGD_HASHDATA"		value="<?= $LGD_HASHDATA ?>" style="width:400px;">								<!-- MD5 해쉬암호값 -->
...
<!-- <input type="hidden" name = "LGD_CUSTOM_FIRSTPAY"		value="SC0010">														<!-- 초기 결제수단 -->
<input type="hidden" name = "LGD_CUSTOM_USABLEPAY";			value="<?=$gubun?>">		<!-- 특정 결제 수단만 보이게 하기 -->
<? /*
<input type="hidden" name="LGD_ESCROW_USEYN"					value="N">																<!-- 에스크로사용유무 -->
