...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr><td height="2" bgcolor="#555" colspan="2"></td></tr>
	<tr>
		<td width="100" height="40" class="tit">성명</td>
		<td width="" style="padding-left:5px;"><input type="text" name="b_writer" style="width:98%; height:28px;" value="<?=$view["b_writer"]?>" class="text" ></td>
	</tr>
	<tr>
		<td width="100" height="40" class="tit">학위과정</td>
		<td width="" style="padding-left:5px;"><input type="text" name="b_ex1" style="width:98%; height:28px;" value="<?=$view["b_ex1"]?>" class="text" <?if($view["b_ex1"]){?>readonly<?}?>></td>
	</tr>
	<tr>
		<td height="40" class="tit">이메일</td>
		<td style="padding-left:5px;"><input type="text" name="b_email" size="70" style="width:98%; height:28px;" value="<?=$view["b_email"]?>" class="text b_email"></td>
	</tr>
	<tr>
		<td width="100" height="40" class="tit">연구분야</td>
		<td width="" style="padding-left:5px;"><input type="text" name="b_ex3" style="width:98%; height:28px;" value="<?=$view["b_ex3"]?>" class="text" ></td>
	</tr>
	<tr>
		<td width="100" height="40" class="tit">PR</td>
		<td width="" style="padding-left:5px;"><input type="text" name="b_ex4" style="width:98%; height:28px;" value="<?=$view["b_ex4"]?>" class="text" <?if($view["b_ex4"]){?>readonly<?}?>></td>
	</tr>
...
<? } ?>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
		...
		<div class="mt30 center">
			...
			<a href="<?=$Url["list"]?>"><div class="bbs_btn" style="background:#ffffff">취소</div></a>
		</div>
