...
/*lab member*/
.lab_member{width:750px; margin-bottom:50px; }
.lab_member:after{display:block; content:''; clear:both; }
.lab_member_pic{width:202px; height:182px; border:1px solid #ddd; float:left; }
.lab_member_pic img{max-width:200px; max-height:180px; }
.lab_member_profile{width:520px; float:right}
.member_profile{margin-top:2px; }
.member_profile th{height:28px; border-bottom:1px solid #dddddd; border-right:1px solid #dddddd; font-size:13px; color:#333; text-align:left; text-indent:10px; }
.member_profile td{padding:4px 10px;  border-bottom:1px solid #dddddd; font-size:13px; color:#555555; }
.member_profile th.top_bd{border-top:2px solid #004483; }
.member_profile td.top_bd{border-top:2px solid #aaaaaa; }
			...
			<table width="200px" height="180px">
				<tr>
					<td style="text-align: center;">
						...
						<?}else{?>
							<?if($LogAdmin==TRUE){?><a href="/bbs/board.php?tbl=<?=$Table?>&mode=MODIFY&num=<?=$list[$i]["b_no"]?>"><?}?>
								<img src="https://placeholdit.imgix.net/~text?txtsize=19&txt=200%C3%97180&w=200&h=180"alt="" />
							<?if($LogAdmin==TRUE){?></a><?}?>
						<?}?>
					</td>
				</tr>
		...
		<div class="lab_member_profile">
			<table width="520" cellpadding="0" cellspacing="0" border="0" class="member_profile">
				...
				<tr>
					...
					<td class="top_bd"><?=$list[$i]["subject"]?></td>
				</tr>
				<tr>
