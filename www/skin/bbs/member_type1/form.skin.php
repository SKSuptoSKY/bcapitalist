...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<input type="hidden" name="b_writer" style="width:98%; height:28px;" value="<?=$view["b_writer"]?>" class="text" <?if($view["b_writer"]){?>readonly<?}?>>
	<!-- <tr>
	...
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr> -->
	<tr height="40">
		<td height="40" class="tit">Name</td>
	...
	<tr height="40">
		<td width="150" height="40" class="tit">Room</td>
		<td width="" style="padding-left:5px;">
			<input type="text" name="b_ex1" style="width:98%; height:28px;" value="<?=$view["b_ex1"]?>" class="text">
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>

	<tr height="40">
		<td width="150" height="40" class="tit">Phone</td>
		<td width="" style="padding-left:5px;">
			<input type="text" name="b_ex2" style="width:98%; height:28px;" value="<?=$view["b_ex2"]?>" class="text">
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>

	<tr>
		<td height="40" class="tit">E-mail</td>
		<td style="padding-left:5px;"><input type="text" name="b_email" size="70" style="width:98%; height:28px;" value="<?=$view["b_email"]?>" class="text"></td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>

	<tr height="40">
		<td width="150" height="40" class="tit">Remark</td>
		<td width="" style="padding-left:5px;">
			<input type="text" name="b_ex3" style="width:98%; height:28px;" value="<?=$view["b_ex3"]?>" class="text">
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>

	<tr height="40">
		<td width="150" height="40" class="tit">Research interest</td>
		<td width="" style="padding-left:5px;">
			<input type="text" name="b_ex4" style="width:80%; height:28px;" value="<?=$view["b_ex4"]?>" class="text">
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>

	<tr height="40">
		<td width="150" height="40" class="tit">노출 순서</td>
		<td width="" style="padding-left:5px;">
			<input type="text" name="b_ex5" style="width:20%; height:28px;" value="<?=$view["b_ex5"]?>" class="text">
			&nbsp;<font size="1" color="#ff0000"> * 숫자가 높은순으로 정렬됩니다.</font>
		</td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
...
?>
	<tr>
		...
		<td style="padding:5px;"><input type="file" name="b_file<?=$i?>" style="width:98%; height:28px;" class="text"><br /> <?=$view["b_file".$i]?></td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
<?
}
...
?>		<tr>
		...
		<tr>
			<td width="150" style="padding:2px;"><a href="#" onclick="document.getElementById('zsfImg').src='zmSpamFree.php?re&amp;zsfimg='+new Date().getTime(); return false;" title=""><img id="zsfImg" src="zmSpamFree.php?zsfimg" alt="[새로고침]을 클릭해 주세요." style="border: none; " /></a></td>
			<td>
...
<table border="0" cellspacing="0" cellpadding="0" align="center" class="mt20">
