...
<input type="hidden" name="tablecategory">
  <tr>
    <td height="2" bgcolor="#999999" colspan="26"></td>
  </tr>
  ...
  <tr height="35" align="center">
    ...
    <td>
		<?
		if($list_file_down[$i]!="") {
			?><a href="<?=$list_file_down[$i]?>"><img src="<?=$Board_Admin["skin_dir"]?>/images/icon_download.gif"></a><?
		}
		?>
    </td>
    <td>&nbsp;</td>
...
<div class="boardsc">
	<form name=search action="<?=$_SERVER[PHP_SELF]?>" autocomplete="off">
	<input type=hidden name=tbl value="<?=$Table?>">
	...
	<? } ?>
	<select name="findType" id="jumpMenu" onchange="" style="width:100px; height:24px;">
	...
	</select>&nbsp;<input name="findWord" type="text" tabindex="1" class="bginput" value="<?=urldecode($findWord)?>" onClick="javascript:if(this.value == '검색어를 입력하세요.'){ this.value = ''};" >&nbsp;<input type="image" src="<?=$Board_Admin["skin_dir"]?>/images/btn_search.jpg" style="vertical-align:top;" />
	</form>
</div>
