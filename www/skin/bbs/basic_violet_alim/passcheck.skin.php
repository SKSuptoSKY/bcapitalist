...
<table align="center" cellpadding="0" cellspacing="0" width="300">
	...
	<TR>
		<TD align=right height=50 style="border-bottom:2px solid #8DB8CD">
			<b><font color=8DB8CD>비밀번호 :</font></b> <input type="password" name="passwd" style="border:0; border-bottom:1px solid #8DB8CD">
		</TD>
	</TR>
	<TR>
