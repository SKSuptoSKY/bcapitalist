...
?>
	<tr>
		<td height="40" class="tit">썸네일 이미지</td>
		<td style="padding:5px;"><input type="file" name="b_file<?=$i?>" style="width:98%; height:28px;" class="text"><br /> <?=$view["b_file".$i]?><font size="1" color="red">※권장사이즈 175 X 60</font></td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
<?
}
...
?>
	...
	<tr>
		...
		<td style="padding-left:5px;"><input type="text" name="b_ex1" size="70" style="width:10%; height:28px;" value="<?=$view["b_ex1"]?>" class="text">&nbsp;&nbsp;<font size="1" color="red">※ 높은순으로 정렬이 됩니다.</font></td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
	<!--
	<tr>
