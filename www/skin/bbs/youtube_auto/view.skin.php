...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center" class="tbl_board">
  <tr height="30" > 
    <th width="13%" height="30" class="tit">제목</th>
    <td height="30" colspan="4" align="left" style="padding-left:10px;word-break:break-all;"> 
      <strong><?=$view["category"]?>
      <?=$view["subject"]?></strong>
    </td>
  </tr>
  <tr height="30" > 
    <th height="30" class="tit">글쓴이</th>
    <td width="37%" height="30" align="left" style="padding-left:10px;word-break:break-all;"> 
      <?=$view["b_writer"]?>
    </td>
    <th width="11%" height="30" class="tit">작성일</th>
    <td width="37%" height="30" align="left" style="padding-left:10px;"> 
      <?=$view["b_regist"]?>
    </td>
  </tr>
  <tr height="30" > 
    <th height="30" class="tit"><div align="center">이메일</th>
    <td height="30" align="left" style="padding-left:10px;"> 
      <?=$view["b_email"]?>
    </td>
    <th height="30" class="tit"><div align="center">수정일</th>
    <td height="30" align="left" style="padding-left:10px;"> 
      <?=$view["b_modify"]?>
    </td>
  </tr>
  ...
  <tr height="30" > 
    <td height="30" class="tit">링크</td>
    <td width="1%" height="30" valign="top"> </td>
    <td height="30" colspan="4" align="left" style="padding-left:10px;"> 
      <?=$linkUrl?>
    </td>
  </tr>
	-->
  ...
  <? if($downTag==TRUE) { ?>
  <tr height="30" > 
    <td height="30" class="tit">첨부파일</td>
    <td height="30" colspan="5" align="left" style="padding-left:10px;"> 
      <?=$downTag?>
    </td>
  </tr>
  <? } ?>
	...
	<? if($view["b_ex1"] != "") { ?>
	<tr> 
		<td colspan="6"><iframe width="760" height="526" src="<?=$view["b_ex1"]?>" frameborder="0" allowfullscreen></iframe></td>
	</tr>
	<? } ?>
	<tr> 
		<td colspan="6">
...
<!-- 댓글작성 여기부터 -->
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="2" align="center" bgcolor="#FAFAFA" style="border-top:1px solid #111;border-right:1px solid #bbb;border-left:1px solid #bbb;border-bottom:1px solid #bbb;">
...
<table width="<?=$Board_Admin["width"]?>" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<th height="30" align="center" style="background:url(/images/sub/b_line.jpg) right no-repeat; text-align:center;border-top:1px solid #e2e2e5;border-bottom:1px solid #e2e2e5;">이전글</th>
		<td style="padding-left:10px;border-top:1px solid #cccccc;"><?=$Url["pre_subject"]?></td>
	</tr>
	<tr>
		<th height="30" align="center" style="background:url(/images/sub/b_line.jpg) right no-repeat; text-align:center;border-top:1px solid #e2e2e5;border-bottom:1px solid #e2e2e5;">다음글</th>
		<td style="padding-left:10px;border-top:1px solid #cccccc;border-bottom:1px solid #cccccc;"><?=$Url["next_subject"]?></td>
	</tr>
</table>
<br>
<?}?>
