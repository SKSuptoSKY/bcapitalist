...
<table width="<?=$Board_Admin["width"]?>" border="0" align="center" cellpadding="0" cellspacing="0">
...
<table align="center" cellpadding="0" cellspacing="0" width="300">
	...
	<TR>
		<TD align=right height=50 style="border-bottom:2px solid #ACB8D1">
			<b><font color=#999999>비밀번호 :</font></b>
			<input type="password" name="passwd" style="border:0; border-bottom:1px solid #94AAD6; " /></TD>
	</TR>
	<TR>
		<TD align=right height=40>
			<input type=submit value="ok~!" class=input style="color:#FFFFFF; background-color:#94AAD6; width:60; height:20; border:0">
			<?if($type != "VIEW"){?>
				<input type=button value="back" class=input style="color:#FFFFFF; background-color:#94AAD6; width:60; height:20; border:0" onclick="document.location.href='/bbs/board.php?tbl=<?=$Table?>&mode=VIEW&num=<?=$num?>&<?=$NextUrl?>&pass=ok'">
			<? }else{ ?>
