...
<input type="hidden" name="tablecategory">
	...
	<tr><td height="2" bgcolor="#086CC0" colspan="20"></td></tr>
	<tr height="28" align="center" bgcolor="#F1F1F1">
		<td style="color:#086CC0;font-weight:bold;">번호</td>
	<? if($Board_Admin["use_category"] == TRUE) { ?>
		<td width="50" style="color:#086CC0;font-weight:bold;">분류</td>
	<? } ?>
		<td style="color:#086CC0;font-weight:bold;"><?if($LogAdmin==TRUE){?><input type="checkbox" onclick="List_Checked_Sel(this.form,this);"><?}?>제목</td>
		<td style="color:#086CC0;font-weight:bold;">글쓴이</td>
		<td style="color:#086CC0;font-weight:bold;">작성일</td>
		<td style="color:#086CC0;font-weight:bold;">조회</td>
	<? if($Board_Admin["use_best"] == TRUE) { ?>
		<td style="color:#086CC0;font-weight:bold;">추천</td>
	<? } ?>
	</tr>
	<tr><td height="2" bgcolor="#086CC0" colspan="20"></td></tr>
