...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr height="28" align="center" bgcolor="#F1F1F1">
		...
		<td class="title" colspan="3" align="left" style="word-break:break-all;"><?=$view["category"]?> <?=$view["subject"]?></td>
	</tr>
	<tr><td height="1" bgcolor="#086CC0" colspan="4"></td></tr>
	<tr height="28" align="center" bgcolor="#F1F1F1">
		<td class="title" width="120">글쓴이</td>
		<td align="left" width="" style="word-break:break-all;"><?=$view["b_writer"]?></td>
		<td class="title" width="120">작성일</td>
		<td align="left" width=""><?=$view["b_regist"]?></td>
	</tr>
	<!--tr><td height="1" bgcolor="#086CC0" colspan="4"></td></tr>
	<tr height="28" align="center" bgcolor="#F1F1F1">
...
<? if($linkUrl==TRUE) { ?>
	<tr><td height="1" bgcolor="#086CC0" colspan="4"></td></tr>
	<tr height="28" align="center" bgcolor="#F1F1F1">
		<td class="title" width="120">링크</td>
		<td colspan="3" align="left"><?=$linkUrl?></td>
	</tr>
<? } ?>
<? if($downTag==TRUE) { ?>
	<tr><td height="1" bgcolor="#086CC0" colspan="4"></td></tr>
	<tr height="28" align="center" bgcolor="#F1F1F1">
		<td class="title" width="120">첨부파일</td>
		<td colspan="3" align="left"><?=$downTag?></td>
	</tr>
<? } ?>
	<tr><td height="2" bgcolor="#086CC0" colspan="4"></td></tr>
	<tr><td height="15" bgcolor="#F1F1F1" colspan="4"></td></tr>
	<tr>
		<td bgcolor="#F1F1F1" colspan="4" style="padding:10px;word-break:break-all;">
			<?=$imgFile?>
			<div id="DivContents" style="line-height:1.4;word-break:break-all;"><?=$view["content"]?></div>
		</td>
	</tr>
	<tr><td height="15" bgcolor="#F1F1F1" colspan="4"></td></tr>
	<tr><td height="2" bgcolor="#086CC0" colspan="4"></td></tr>
