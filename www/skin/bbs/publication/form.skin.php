...
<input type="hidden" name="b_subject" size="70" style="width:70%; height:28px;" value="<?=($mode == "WRITE")?$datetime:$view["b_subject"]?>" class="text">
...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
		...
		<td style="padding-left:5px;">
            <input type="text" name="b_ex1" size="70" style="width:10%; height:28px;" value="<?=$view["b_ex1"]?>" class="text">
            <font size="1" color="red">※ 높은 순으로 정렬이 됩니다.</font>
        </td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
<? if($Category_option==TRUE) {?>
