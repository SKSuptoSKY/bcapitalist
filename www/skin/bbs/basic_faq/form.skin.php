...
<style>
.tit {font-weight:bold;color:#666;text-align:center; font-size:14px; color:#464646;}
.bbs_btn{width:120px; height:34px; background:#f1f1f1;  font-weight:700; border:1px solid #dbdbdb; color:#111111; text-align:center; line-height:32px; vertical-align:top; cursor:pointer; display:inline-block; }
...
<table width="<?=$Board_Admin["width"]?>" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr><td height="2" bgcolor="#393939" colspan="2"></td></tr>
	<tr>
		<td width="100" height="45" class="tit">작성자</td>
		<td width="" style="padding-left:5px;"><input type="text" name="b_writer" style="width:20%; height:25px;" value="<?=$view["b_writer"]?>" class="text" <?if($view["b_writer"]){?>readonly<?}?>></td>
	</tr>
	<tr><td height="1" bgcolor="#dfdfdf" colspan="2"></td></tr>
	<tr>
		<td height="45" class="tit">제목</td>
		<td style="padding-left:5px;">
			<table cellpadding=0 cellspacing=0 border=0 width=100%>
				<tr>
					<td>
						<input type="text" name="b_subject" size="70" style="width:70%; height:25px;" value="<?=$view["b_subject"]?>" class="text">
...
<? if($Category_option==TRUE) {?>
	<tr>
		...
		<td style="padding-left:5px;">
			<select name="b_category" style='width:80px; height:25px;' class="text">
				<?=$Category_option?>
			</select>
		</td>
	</tr>
...
?>
	<tr>
		...
		<td style="padding-left:5px;"><input type="file" name="b_file<?=$i?>" style="width:98%; height:25px;" class="text"> <?=$view["b_file".$i]?></td>
	</tr>
	<tr><td height="1" bgcolor="#EAEAEA" colspan="2"></td></tr>
<?
}
...
<table border="0" cellspacing="0" cellpadding="0" align="center" class="mt20">
	<tr height="50" valign="middle">
		<td style="padding-left:50px;">
			<input type="submit" border="0" onclick="return writeChk(writeform)" value="확인" class="bbs_btn" style="cursor:pointer;">&nbsp;
