...
nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
	...
	addAllFonts : function(){
		...
		if(!this.htOptions || !this.htOptions.aDefaultFontList || this.htOptions.aDefaultFontList.length === 0){
			this.addFont("돋움,Dotum", "Dotum", 0, "", "", 1);
			this.addFont("돋움체,DotumChe", "DotumChe", 0, "", "", 1);
			this.addFont("굴림,Gulim", "Gulim", 0, "", "", 1);
			this.addFont("굴림체,GulimChe", "GulimChe", 0, "", "", 1);
			this.addFont("바탕,Batang", "Batang", 0, "", "", 1);
			this.addFont("바탕체,BatangChe", "BatangChe", 0, "", "", 1);
			this.addFont("궁서,Gungsuh", "Gungsuh", 0, "", "", 1);
